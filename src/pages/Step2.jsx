...
import DayMenuCollapse from "../components/DropDownMenu";
  ...
  return (
    ...
    >
      <><h2 className="text-[#2e8b57] text-center font-bold text-2xl m-0">
          Smart Meal Planner
        </h2><div className="text-center text-gray-500 text-sm mt-1 mb-6">
            Rencana Menu Mingguan Anda
          </div><div className="space-y-3">
            {WEEKLY_MENU.map((dayData) => (
              <DayMenuCollapse key={dayData.day} dayData={dayData} />
            ))}
          </div><div className="flex justify-between items-center mt-8">
            <Link
              to="/step-1"
